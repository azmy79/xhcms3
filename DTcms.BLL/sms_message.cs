                ...
                if (sb.ToString().Length > 0)
                {
                    try
                    {
                        string result = Utils.HttpPost(siteConfig.smsapiurl,
                            "user=" + siteConfig.smsusername + "&pass=" + siteConfig.smspassword + "&phone=" + Utils.DelLastComma(sb.ToString()) + "&content=" + System.Web.HttpUtility.UrlEncode("【长江公证处】" + content, Encoding.UTF8));

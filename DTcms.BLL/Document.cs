...
namespace DTcms.BLL {
		...
		public partial class Document
	{
		...
		private readonly DTcms.DAL.Document dal=new DTcms.DAL.Document();
		public Document()
		{}
		...
		/// 获得数据列表
		/// </summary>
		public List<DTcms.Model.Document> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DTcms.Model.Document> DataTableToList(DataTable dt)
		{
			List<DTcms.Model.Document> modelList = new List<DTcms.Model.Document>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DTcms.Model.Document model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new DTcms.Model.Document();					
        ...
        /// 获得查询分页数据
        /// </summary>
        public List<DTcms.Model.Document> GetModelList(int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {

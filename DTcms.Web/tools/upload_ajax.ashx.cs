...
namespace DTcms.Web.tools
{
    ...
    public class upload_ajax : IHttpHandler, IRequiresSessionState
    {
        ...
        private void UpLoadFile(HttpContext context)
        {
            ...
            //文件类型
            switch (DTRequest.GetString("filetype"))
            {
                case "bidsourcefile":
                    msg = upFiles.fileSaveAs(_upfile, "/upload/BidSource/" + DateTime.Now.ToString("yyyyMM") + "/" + DateTime.Now.ToString("dd") + "/", _isthumbnail, _iswater);
                    break;
                case "documentfile":
                    msg = upFiles.fileSaveAs(_upfile, "/upload/Document/" + DateTime.Now.ToString("yyyyMM") + "/" + DateTime.Now.ToString("dd") + "/", _isthumbnail, _iswater);
                    break;
                default:

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="News_View.aspx.cs" Inherits="DTcms.Web.MWeb.News_View" %>
...
<body>
    ...
    <%
        var model = ReadArticle(DTcms.Common.DTRequest.GetQueryInt("id"));

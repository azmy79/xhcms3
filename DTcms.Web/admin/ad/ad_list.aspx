<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ad_list.aspx.cs" Inherits="DTcms.Web.admin.ad.ad_item_list" %>
	...
	<form id="form1" runat="server">
		...
		<div class="toolbar-wrap">
			<div id="floatHead" class="toolbar">
				<div class="l-list">
					<ul class="icon-list">
						<li><a class="add" href="ad_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
						<li>
		...
		<asp:Repeater ID="rptList1" runat="server">
			...
			<ItemTemplate>
				<tr>
					...
					<td><a href="ad_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
					<td><%#string.Format("{0:g}",Eval("add_time"))%></td>
					<td>
						<asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("sort_id")%>' CssClass="sort" onkeydown="return checkNumber(event);" /></td>
					<td align="center">
						<a href="ad_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
						<a href="ad_code.aspx?id=<%#Eval("id")%>">代码</a>
						<a href="ad_item.aspx?ad_id=<%#Eval("id")%>">内容管理</a>
					</td>
				</tr>
			</ItemTemplate>
			<FooterTemplate>
			...
			<ItemTemplate>
				<li>
					<div class="details nopic">
						...
						<h1><span><a href="ad_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></span></h1>
						<div class="remark">
						...
						<div class="foot">
							...
							<a href="ad_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
						</div>
					</div>
				</li>
			</ItemTemplate>

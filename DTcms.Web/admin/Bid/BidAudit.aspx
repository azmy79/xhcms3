<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BidAudit.aspx.cs" Inherits="DTcms.Web.admin.Bid.BidAudit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="BidList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="BidList.aspx"><span>申办信息管理</span></a>
            <i class="arrow"></i>
            <span>申办信息详细</span>
        </div>
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">申办信息详细信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <dd>
                    <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
                        ...
                        <tr>
                            <th width="20%">翻译价格</th>
                            <td>
                                <asp:TextBox ID="txtTranslationPrice" runat="server" CssClass="input small" datatype="n" sucmsg=" " Text="0"></asp:TextBox>
                                <span class="Validform_checktip">(元)*</span>
                            </td>
                        </tr>
                    </table>
                    <script>
                        $("#txtTranslationPrice").change(function () {
                            $("#txtPrice").val(parseInt("<%=totalPrice%>") + (!$(this).val() || isNaN($(this).val()) ? 0 : parseInt($(this).val())))
                        });
                    </script>
                </dd>
            </dl>

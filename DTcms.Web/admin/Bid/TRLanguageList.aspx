<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TRLanguageList.aspx.cs" Inherits="DTcms.Web.admin.Bid.TRLanguageList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="TRLanguageEdit.aspx"><i></i><span>新增</span></a></li>
                        <li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                <HeaderTemplate>
                    <tr>
                        <th width="6%">选择</th>
                        <th align="left">名称</th>
                        <th align="left" width="12%">默认价格</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href="TRLanguageEdit.aspx?option=edit&id=<%#Eval("ID")%>"><%#Eval("Name")%></a>
                        </td>
                        <td>
                            ￥<%#Convert.ToInt32(Eval("DefaultPrice")) %>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("Sort")%>' CssClass="sort" onkeydown="return checkNumber(event);" />
                        </td>
                        <td align="center">
                            <a href="TRLanguageEdit.aspx?option=edit&id=<%#Eval("ID")%>">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurposeList.aspx.cs" Inherits="DTcms.Web.admin.Bid.PurposeList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="PurposeEdit.aspx"><i></i><span>新增</span></a></li>
                        <li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href="PurposeEdit.aspx?option=edit&id=<%#Eval("ID")%>"><%#Eval("Name")%></a>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSortId" runat="server" Text='<%#Eval("Sort")%>' CssClass="sort" onkeydown="return checkNumber(event);" />
                        </td>
                        <td align="center">
                            <a href="PurposeEdit.aspx?option=edit&id=<%#Eval("ID")%>">修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurposeEdit.aspx.cs" Inherits="DTcms.Web.admin.Bid.PurposeEdit" %>

<!DOCTYPE>
<html>
<head>
    <title><%=IsEdit? "修改" : "新增"%>用途</title>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="PurposeList.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="PurposeEdit.aspx"><span>用途管理</span></a>
            <i class="arrow"></i>
            <span><%=IsEdit ? "修改" : "新增"%>用途</span>
        </div>

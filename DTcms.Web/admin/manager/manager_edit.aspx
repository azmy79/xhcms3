        ...
        $(function () {
            ...
            $("#divUploadImg").InitSWFUpload({
                ...
                uploadSuccess: function (file, serverData) {
                    ...
                    $("#hidHeadImg").val(serverData.path);
                    $("#divPanoramicPicture").html("<img width=\"200px\" height=\"250px\" src=\"" + serverData.path + "\" /><input type=\"button\" value=\"删除\" onclick=\"$('#divPanoramicPicture').empty();hidHeadImg.value='';\" />");
                }
            });
        });
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>头像</dt>
                <dd>
                    <input type="hidden" id="hidHeadImg" runat="server" />

...
namespace DTcms.Web.admin.manager
{
    public partial class manager_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            {
                hidHeadImg.Value = model.HeadImg;
                divPanoramicPicture.InnerHtml = "<img width=\"200px\" height=\"250px\" src=\"" + model.HeadImg + "\" /><input type=\"button\" value=\"删除\" onclick=\"$('#divPanoramicPicture').empty();hidHeadImg.value='';\" />";
            }
        }
        #endregion
        ...
        private bool DoAdd()
        {
            ...
            model.HeadImg = hidHeadImg.Value;
            if (bll.Add(model) > 0)
            {

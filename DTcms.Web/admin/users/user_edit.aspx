    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-multi-radio">
                        <asp:RadioButtonList ID="ralCartType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                        </asp:RadioButtonList>
                    </div>
                </dd>
            </dl>
            <dl>
                <dt>证件号码</dt>
                <dd>
                    <asp:TextBox ID="txtCartNum" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>姓名</dt>
                <dd>
                    <asp:TextBox ID="txtCnName" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>英文名</dt>
                <dd>
                    <asp:TextBox ID="txtEnName" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>现住地</dt>
                <dd>
            ...
            <dl>
                <dt>户籍所在地</dt>
                <dd>
                    <asp:TextBox ID="txtCRAddress" runat="server" CssClass="input normal"></asp:TextBox></dd>
            </dl>
        </div>

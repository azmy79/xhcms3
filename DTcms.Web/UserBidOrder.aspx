<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserBidOrder.aspx.cs" Inherits="DTcms.Web.UserBidOrder" %>
                        ...
                        <script>
                            ...
                            $(".page").SetPagination({
                                ...
                                htmlJoinFunc: function (htmlArr, i, obj) {
                                    htmlArr.push("<tr>");
                                    htmlArr.push("    <td>" + obj.OrderNo + "</td>");
                                    htmlArr.push("    <td>" + obj.Number + "</td>");
                                    htmlArr.push("    <td>" + obj.BidBusiness + "</td>");
                                    htmlArr.push("    <td>￥" + parseInt(obj.OrderAmount) + "</td>");
                                    htmlArr.push("    <td>已支付</td>");
                                    htmlArr.push("    <td>" + obj.PaymentTime.ToDate().ToString("yyyy-MM-dd") + "</td>");
                                    htmlArr.push("    <td><a href=\"UserBidComment.aspx?id=" + obj.ID + "\">【评论服务】</a></td>");
                                    htmlArr.push("</tr>");

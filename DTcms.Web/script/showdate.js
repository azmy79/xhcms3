...
'#Tools {width:204px;background:#ff7e00;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #666666;background:#666666;}'+
'#Title {width:204px;background:#cccccc;border-bottom:1px solid #ccccccc;}'+
...
'#Select #SelectBn {background:#ff7e00;font-size:8px;line-height:7px;height:7px;text-align:center;color:#ffffff;}'+
'#Select #SelectBn:hover{background:#666666;color:#FFF;}#SArr,#sYear,#sMonth{float:left;}'+

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TableDownView.aspx.cs" Inherits="DTcms.Web.TableDownView" %>
        ...
        <div class="right_common">
            ...
            <div class="w_bg">
                <%
                    ...
                    var navList = new DTcms.BLL.article_category().GetChildList(cid, 1);
                    foreach (System.Data.DataRow item in navList.Rows)
                    {
                        Response.Write("<h3 class=\"style_but3\">" + item["title"].ToString() + "</h3>");
                        Response.Write("<div class=\"list_dwon\">");
                        GetNews(Convert.ToInt32(item["id"])).ForEach(p =>
                        {
